  ...
  const handleExcelFile = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    const resolveEnergyTypeIdFromRow = (row: any) => {
      ...
      const energyIdFallbacks: Record<string, string> = {
        ...
        incoloro: '13500355-8b76-46ce-b874-362acda803ec',
        volador: '13500355-8b76-46ce-b874-362acda803ec',
        ...
        oscuridad: '5cc929c6-b2a4-4251-b437-3aacf4bd39fc',

...
exports.default = MyCollectionPage;
const react_1 = __importStar(require("react"));
const link_1 = __importDefault(require("next/link"));
const INITIAL_USER_CARDS = [
...
function MyCollectionPage() {
    const [userCards, setUserCards] = (0, react_1.useState)(INITIAL_USER_CARDS);
    ...
    return (<div style={{ minHeight: '100vh', backgroundColor: '#09090b', color: '#f4f4f5', padding: 'clamp(1rem, 4vw, 2rem)' }}>
      <div className="collection-shell" style={{ maxWidth: '1100px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '2rem' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid #27272a', paddingBottom: '1.5rem' }}>
          ...
          <link_1.default href="/catalog" style={{ backgroundColor: '#a855f7', color: '#ffffff', textDecoration: 'none', padding: '0.6rem 1.25rem', borderRadius: '8px', fontWeight: 600 }}>
            + Agregar Cartas
          </link_1.default>
        </div>
        ...
        <div className="collection-table-wrap" style={{ backgroundColor: '#18181b', border: '1px solid #27272a', borderRadius: '12px', overflowX: 'auto' }}>
          <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left', fontSize: '0.9rem' }}>
            ...
            <tbody>
              {userCards.map((card) => (<tr key={card.id} style={{ borderBottom: '1px solid #27272a' }}>

...
exports.CreateVisualPresetDto = void 0;
const class_validator_1 = require("class-validator");
let CreateVisualPresetDto = (() => {
    ...
    return class CreateVisualPresetDto {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _name_decorators = [(0, class_validator_1.IsNotEmpty)({ message: 'El nombre del preset es obligatorio' }), (0, class_validator_1.IsString)()];
            _shader_decorators = [(0, class_validator_1.IsNotEmpty)({ message: 'El nombre del shader GLSL es obligatorio' }), (0, class_validator_1.IsString)()];
        ...
        intensity = (__runInitializers(this, _animation_extraInitializers), __runInitializers(this, _intensity_initializers, 50));
        constructor() {
            __runInitializers(this, _intensity_extraInitializers);
        }
    };
})();
exports.CreateVisualPresetDto = CreateVisualPresetDto;

...
let RaritiesController = (() => {
    let _classDecorators = [(0, common_1.Controller)('rarities')];
    ...
    var RaritiesController = class {
        ...
        static {
            ...
            RaritiesController = _classThis = _classDescriptor.value;
            if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
            __runInitializers(_classThis, _classExtraInitializers);
        }
        raritiesService = __runInitializers(this, _instanceExtraInitializers);
    ...
    return RaritiesController = _classThis;
})();

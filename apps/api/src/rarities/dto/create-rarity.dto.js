...
exports.CreateRarityDto = void 0;
...
let CreateRarityDto = (() => {
    ...
    return class CreateRarityDto {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _name_decorators = [(0, class_validator_1.IsNotEmpty)({ message: 'El nombre es obligatorio' }), (0, class_validator_1.IsString)()];
            _level_decorators = [(0, class_validator_1.IsNotEmpty)({ message: 'El nivel de rareza es obligatorio' }), (0, class_validator_1.IsEnum)(client_1.RarityLevel, { message: 'El nivel de rareza no es válido' })];
...
exports.CreateRarityDto = CreateRarityDto;

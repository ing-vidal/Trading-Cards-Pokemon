...
let CreateCategoryDto = (() => {
    ...
    return class CreateCategoryDto {
        static {
            ...
            _name_decorators = [(0, class_validator_1.IsNotEmpty)({ message: 'El nombre de la categoría es obligatorio' }), (0, class_validator_1.IsString)()];
            _slug_decorators = [(0, class_validator_1.IsNotEmpty)({ message: 'El slug de la categoría es obligatorio' }), (0, class_validator_1.IsString)()];
        ...
        image = (__runInitializers(this, _description_extraInitializers), __runInitializers(this, _image_initializers, void 0));
        constructor() {

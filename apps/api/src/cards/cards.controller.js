...
let CardsController = (() => {
    let _classDecorators = [(0, common_1.Controller)('cards')];
    ...
    var CardsController = class {
        ...
        static {
            ...
            _removeMany_decorators = [(0, common_1.Delete)('bulk')];
        ...
        cardsService = __runInitializers(this, _instanceExtraInitializers);

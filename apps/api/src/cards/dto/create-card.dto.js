...
let CreateCardDto = (() => {
    ...
    return class CreateCardDto {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _name_decorators = [(0, class_validator_1.IsNotEmpty)({ message: 'El nombre de la carta es obligatorio' }), (0, class_validator_1.IsString)()];
            _slug_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
            _number_decorators = [(0, class_validator_1.IsNotEmpty)({ message: 'El número de colección es obligatorio' }), (0, class_validator_1.IsString)()];

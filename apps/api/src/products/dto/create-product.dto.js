...
let CreateProductDto = (() => {
    ...
    return class CreateProductDto {
        static {
            ...
            _condition_decorators = [(0, class_validator_1.IsNotEmpty)({ message: 'La condición de la carta es obligatoria' }), (0, class_validator_1.IsEnum)(client_1.ProductCondition, { message: 'La condición del producto no es válida' })];
            _price_decorators = [(0, class_validator_1.IsNotEmpty)({ message: 'El precio del producto es obligatorio' }), (0, class_validator_1.IsNumber)({}, { message: 'El precio debe ser un número válido' }), (0, class_validator_1.Min)(0.01)];
            _stock_decorators = [(0, class_validator_1.IsNotEmpty)({ message: 'El stock disponible es obligatorio' }), (0, class_validator_1.IsInt)(), (0, class_validator_1.Min)(0)];
        ...
        cardId = __runInitializers(this, _cardId_initializers, void 0);
        sku = (__runInitializers(this, _cardId_extraInitializers), __runInitializers(this, _sku_initializers, void 0));
        ...
        status = (__runInitializers(this, _stock_extraInitializers), __runInitializers(this, _status_initializers, client_1.ProductStatus.AVAILABLE));
        constructor() {
